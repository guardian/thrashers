...
(function(){
  ...
  function updateContent() {
    loadJSON("https://interactive.guim.co.uk/docsdata-test/1GIQlfF9hZFT4N-undyEzG8HL7KFXhdLVdvsjfE-yIx0.json", function(data) {
      ...
      for (var i = 0; i < pageCards.length; i++) {
        ...
        if (cardsData[i]['Quote'] == 'Yes') {
          pageCards[i].querySelector('.description').classList.add('quote');
        }
      }
