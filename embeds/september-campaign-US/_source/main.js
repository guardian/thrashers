(function() {
    function variantAssignator() {
        ...
        window.guardian.ophan.record({
			component: ('thrasher : september campaign us: variant '+variant),
			value: 1
		});
    ...
    function checkExists(startThrasherFunction) {
        var checkInterval = setInterval(function() {
            if (document.querySelector('.september-campaign-US__wrapper')) {
	...
	function playThrasher() {
		...
		var thrasher = document.querySelector('.september-campaign-US__wrapper');
