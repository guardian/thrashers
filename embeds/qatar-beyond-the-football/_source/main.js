function findTargetContainer(container) {
    ...
    if (classes.contains('fc-container--thrasher') || classes.contains('fc-container--commercial') || classes.contains('fc-container--video') || classes.contains('fc-container__mpu--mobile')) {
...
function thrasherMain() {
    // find this thrasher
    var thrasher = document.querySelector('.qatar-nugget');
...
function checkExists(startThrasherFunction) {
    var checkInterval = setInterval(function () {
        if (document.querySelector('.qatar-nugget')) {
