...
function animateBar() {
    var progressBarElement = document.querySelector('.us-eoy-2021-post-jan__wrapper .us-end-of-year-2019__progress-complete');
...
function increaseCounter() {
    ...
    var counterElement = document.querySelector('.us-eoy-2021-post-jan__wrapper .us-end-of-year-2019__count span');
...
function fetchDataAndAnimate() {
    fetch('https://support.theguardian.com/ticker.json').then(function (resp) {
        ...
        if (total >= 1250000) {
            ...
            document.querySelector('.us-end-of-year-2019__total').classList.add("us-end-of-year-2019__goal_reached");
            completedGoal = true;
        }
