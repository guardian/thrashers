...
function animateBar() {
    var progressBarElement = document.querySelector('.us-end-of-year-2019-dec-27__progress-complete');
...
function increaseCounter() {
    ...
    var counterElement = document.querySelector('.us-end-of-year-2019-dec-27__count');
