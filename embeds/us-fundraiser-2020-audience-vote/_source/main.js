...
function animateBar() {
    var progressBarElement = document.querySelector('.us-fundraiser-2020-audience-vote__progress-complete');
...
function increaseCounter() {
    ...
    var counterElement = document.querySelector('.us-fundraiser-2020-audience-vote__count');
