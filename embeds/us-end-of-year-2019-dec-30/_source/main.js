...
function animateBar() {
    var progressBarElement = document.querySelector('.us-end-of-year-2019-dec-30__progress-complete');
...
function increaseCounter() {
    ...
    var counterElement = document.querySelector('.us-end-of-year-2019-dec-30__count');
