...
function animateBar() {
    var progressBarElement = document.querySelector('.us-eoy-container-v1 .us-end-of-year__progress-complete');
...
function increaseCounter() {
    ...
    var counterElement = document.querySelector('.us-eoy-container-v1 .us-end-of-year__count span');
...
function fetchDataAndAnimate() {
    fetch('https://support.theguardian.com/ticker/US_2022.json').then(function (resp) {
        ...
        if (total >= 1250000) {
            ...
            goal = 1388889;
            document.querySelector('.us-eoy-container-v1 #us-end-of-year__our_goal').innerHTML = "<span class='us-end-of-year__red'>But it's not too late to give!</span>";
            document.querySelector('.us-eoy-container-v1 .us-end-of-year__total').classList.add("us-end-of-year__goal_reached");
            completedGoal = true;
        }
