...
function animateBar() {
    var progressBarElement = document.querySelector('.us-impeachment-day-after__progress-complete');
...
function increaseCounter() {
    ...
    var counterElement = document.querySelector('.us-impeachment-day-after__count');
