...
function animateBar() {
    var progressBarElement = document.querySelector('.us-new-year-fundraiser__progress-complete');
...
function increaseCounter() {
    ...
    var counterElement = document.querySelector('.us-new-year-fundraiser__count');
