;(function ( global ) {
  ...
  var wantsVideo = (function() {
    ...
    var elements = document.getElementsByClassName("deaths-inside__wrapper")[0];
    ...
    elements.addEventListener('click',() => {
      window.location.href = "https://www.theguardian.com/australia-news/series/deaths-inside";
    });
